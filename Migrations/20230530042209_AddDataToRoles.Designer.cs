...
namespace API.Migrations
{
    ...
    [Migration("20230530042209_AddDataToRoles")]
    partial class AddDataToRoles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("2483b7c6-10bd-4ee4-69d9-08db60bf2967"),
                            CreatedDate = new DateTime(2023, 5, 30, 11, 22, 8, 887, DateTimeKind.Local).AddTicks(1255),
                            ModifiedDate = new DateTime(2023, 5, 30, 11, 22, 8, 887, DateTimeKind.Local).AddTicks(1265),
                            Name = "User"
                        },
                        new
                        {
                            Guid = new Guid("6aaad8e7-364f-45d9-69da-08db60bf2967"),
                            CreatedDate = new DateTime(2023, 5, 30, 11, 22, 8, 887, DateTimeKind.Local).AddTicks(1268),
                            ModifiedDate = new DateTime(2023, 5, 30, 11, 22, 8, 887, DateTimeKind.Local).AddTicks(1269),
                            Name = "Manager"
                        },
                        new
                        {
                            Guid = new Guid("17886cc3-5ad9-4640-69db-08db60bf2967"),
                            CreatedDate = new DateTime(2023, 5, 30, 11, 22, 8, 887, DateTimeKind.Local).AddTicks(1272),
                            ModifiedDate = new DateTime(2023, 5, 30, 11, 22, 8, 887, DateTimeKind.Local).AddTicks(1272),
                            Name = "Admin"
                        });
                });
